...
ENTRY_SRCS=(src/adapter/yl_adapter_entry.f90 src/authoring/yl_authoring_prelude.f90)
SOLVER_REPO_SRCS=()
if [ "$TARGET" = solver ] || [ "$TARGET" = solver-adapter ]; then
    SOLVER_REPO_SRCS=(src/problem/yl_problem_optional.f90
                      ...
                      src/authoring/yl_authoring_keys.f90
                      src/authoring/yl_authoring_report.f90
                      src/authoring/yl_authoring_defaults.f90
                      src/authoring/yl_authoring_map.f90)
fi
...
if [ "$TARGET" = runtime-bridge ] || [ "$TARGET" = adapter ]; then
    ...
    RB_REPO_SRCS=(src/problem/yl_problem_optional.f90
                  ...
                  src/authoring/yl_authoring_prelude_stub.f90)
